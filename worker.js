...
function helpText() {
  return (
    "ℹ️ راهنما\n\n" +
    "راهنما بخش‌بندی شده است؛ روی هر بخش بزن تا راهنمای همان بخش را ببینی.\n" +
    "برای روش «جست‌وجوی سریع» (فرستادن آی‌پی/ساب‌دامنه در چت) دکمهٔ قرمز «⚡ جای‌گذاری سریع» را بزن.\n\n" +
    "🌐 مدیریت رله (شخصی/رایگان/خودکار) هم داخل همین راهنماست — با دکمه‌های قرمز:\n" +
    "🔧 تنظیم مجدد رله · 🌐 انتخاب رله پیش‌فرض · 🗑 حذف رله فعلی\n\n" +
...
const HELP_GUIDE = {
  ...
  help:
    "ℹ️ راهنما — بخش‌بندی\n\n" +
    "راهنما به چند بخش تقسیم شده؛ روی هر دکمه بزنی راهنمای همان بخش را می‌بینی:\n\n" +
    ...
    "⚙️ مدیریت: راهنما · مدیریت ادمین\n\n" +
    "• دکمهٔ قرمز «⚡ جای‌گذاری سریع» روش جست‌وجو با فرستادن آی‌پی/ساب‌دامنه در چت است.\n" +
    "• دکمه‌های قرمز «🔧 تنظیم مجدد رله / 🌐 رله پیش‌فرض / 🗑 حذف رله» مدیریت رله هستند.\n\n" +
    "💡 رنگ دکمه‌ها: قرمز = مهم/خطرناک · آبی = دو یا چند ستونه · سبز = تک‌ستونه یا سه‌ستونه · خاکستری = ساده",
};
