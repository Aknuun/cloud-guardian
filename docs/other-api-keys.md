...
## آروان (برای مدیریت DNS آروان)

۱. وارد پنل آروان: `console.arvancloud.com`
۲. از پایینِ منوی چپ: **تنظیمات حساب** ← **کلیدهای API**
۳. یک کلید جدید بسازید و مقادیر **API Key** و **Account ID** را کپی کنید.
۴. در ربات: بخش «آروان» ← افزودن اکانت ← فیلدها را پر کنید.
...
## رلهٔ SSH (پایش سرور + اجرای SSH از ربات)
