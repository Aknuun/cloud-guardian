...
- ✉️ **ایمیل‌ها** (داخل ✨ فیچرهای جدید): دریافت ایمیل‌های دامنه‌ها در تلگرام — هر دامنه با یک دکمه وصل می‌شود (چند دامنه همزمان) و متن ایمیل‌ها در صندوق ورودی نمایش داده می‌شود.
