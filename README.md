...
`☁️ کلودفلر` · `🇩🇪 هتزنر` · `🟢 لینود` · `🇮🇷 آروان` · `🖥 مانیتورها`
...
<b>🏠 منوی اصلی</b><br>
🔍 جست‌وجو در همه · ⭐ ساب‌های منتخب · ☁️ کلودفلر · 🏢 دیتاسنترها (هتزنر، لینود و آروان) · 🗂 عملیات گروهی · ➕ افزودن رکورد · 🖥 مانیتورها · ℹ️ راهنما · 👥 مدیریت ادمین<br><br>
...
🌐 دامنه‌ها · 📋 رکوردها · ✏️ تغییر مقدار (تعویض IP) · ☁️ روشن/خاموش ابری · ➕ افزودن رکورد · 🗑 حذف رکورد<br>
🖥 سرورها (به‌تفکیک ریجن) · ➕ ساخت سرور (نام، ایمیج، پلن، شبکه، کلید SSH) · ⚡ روشن · 🔌 خاموش · 🔄 ریبوت · 📷 اسنپ‌شات · ✏️ تغییرنام · 🔑 ریست رمز root · 🗑 حذف سرور<br>
