...
- ✉️ **ایمیل سازمانی** (داخل ✨ فیچرهای جدید): دریافت ایمیل‌های دامنه‌ها در تلگرام — هر دامنه با یک دکمه وصل می‌شود (چند دامنه همزمان)، متن ایمیل‌ها در صندوق نمایش داده می‌شود، لینک‌های داخل ایمیل قابل کلیک‌اند و هر ایمیل با دکمه «↪️ فوروارد» به هر چت/یوزر (`@یوزرنیم` یا شناسه عددی، چند مقصد) فوروارد می‌شود.
