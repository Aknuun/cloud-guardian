...
مدیریت کامل **دامنه، DNS، پنل پاسارگارد و سرورها (هتزنر، لینود)** در تلگرام — روی **Cloudflare Workers** اجرا میشود؛ بدون هیچ سروری برای اجرا (فقط یک سرور برای نصب لازم است).
...
`☁️ کلودفلر` · `🇩🇪 هتزنر` · `🟢 لینود` · `🖥 مانیتورها`
...
<b>🏠 منوی اصلی</b><br>
🔍 جست‌وجو در همه · ⭐ ساب‌های منتخب · ☁️ کلودفلر · 🏢 دیتاسنترها (هتزنر و لینود) · 🗂 عملیات گروهی · ➕ افزودن رکورد · 🖥 مانیتورها · ℹ️ راهنما · 👥 مدیریت ادمین<br><br>
